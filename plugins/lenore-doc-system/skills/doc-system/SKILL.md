...
| User wants a report for non-technical stakeholders | Run `/lenore-doc-system:stakeholder-brief` — compiles journal span + stakeholder notes + verdicts + figures into a self-contained HTML note (`docs/notes/YYYY-MM-DD-brief-<slug>.html`); user reviews before commit. |
